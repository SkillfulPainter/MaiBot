...
class ResponseGenerator:
    def __init__(self):
        ...
        self.model_sum = LLM_request(
            model=global_config.llm_summary_by_topic, temperature=1.0, max_tokens=2000, request_type="relation"
        )
    ...
    async def generate_response(self, message: MessageRecv, thinking_id: str) -> Optional[List[str]]:
        ...
        if model_response:
            ...
            url = f"http://10.20.233.36:5000/tts?{'&'.join(query_parts)}"
