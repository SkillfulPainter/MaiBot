...
USER_AGENT_BING = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/135.0.0.0 Safari/537.36"
    ...
    async def search(self, query: str, num_results: int) -> List[SearchResult]:
        ...
        try:
            ...
            for link in links:
                ...
                url = link.select_one(self._set_selector("url"))["href"]
                snippet = ""
                if title and url:
